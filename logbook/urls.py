...
events_nested_router = routers.NestedSimpleRouter(entries_router, r'entries', lookup='entry')
events_nested_router.register(r'events', EventNestedView, basename='entry-events')
